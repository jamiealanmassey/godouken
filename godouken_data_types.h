...
struct GodoukenDataNodeSignal : GodoukenDataNodeSimple
{
    ...
    node_name(p_node_data_simple.node_name),
    node_desc_brief(p_node_data_simple.node_desc_brief),
    node_desc_detailed(p_node_data_simple.node_desc_detailed);
...
struct GodoukenDataNodeScript : GodoukenDataNodeBase
{
    ...
    node_extra_warning(p_node_data_base.node_extra_warning),
    node_extra_info(p_node_data_base.node_extra_info),
    node_collection(p_node_data_base.node_collection),
    node_return_type(p_node_data_base.node_return_type),
    node_name(p_node_data_simple.node_name),
    node_desc_brief(p_node_data_simple.node_desc_brief),
    node_desc_detailed(p_node_data_simple.node_desc_detailed);
